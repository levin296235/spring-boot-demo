...
public class SocketUtils {
    ...
    private static String archivesCenterAPIIP = StringUtils.defaultString("127.0.0.1");
    private static String archivesCenterAPIPort = StringUtils.defaultString("24992");
