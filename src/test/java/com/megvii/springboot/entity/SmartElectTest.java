 ...
 **/
public class SmartElectTest{
    private Integer _device_TypeId;
        public SmartElectTest() {
...
//                logger.error(e.getMessage());
        ...
        private boolean uploadData(String data, BaseData baseData) {
            ...
            try {
                ...
                // 左补0
                warnStatus = StringUtils.leftPad(warnStatus,16);
                ...
                // 左补0
                warnStatus2 = StringUtils.leftPad(warnStatus2,16);
                ...
                // 左补0
                warnStatus3 = StringUtils.leftPad(warnStatus3,16);
...
//                CacheRealValue.map.put(baseData.getDevsignature()+String.format("%02x", (0x80 + Integer.parseInt(baseData.getUdpPacketType(),16))),"false|" + System.currentTimeMillis());
    ...
    public static void main(String[] args) {
        String dataHex = "FF FF 92 24 00 23 36 FF 00 70 06 50 56 37 32 21 27 02 43 01 41 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 16 00 16 00 16 00 16 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 32 00 32 00 32 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 11 04 B0 04 B0 04 B0 04 B0 04 B0 04 B0 00 00 00 00 07 ";
        dataHex = dataHex.replaceAll(" ","");
        BaseData bd = new BaseData();
        bd.setUdpData(dataHex);
        SmartElectTest st = new SmartElectTest();
        boolean flag = st.Analysis(bd);
